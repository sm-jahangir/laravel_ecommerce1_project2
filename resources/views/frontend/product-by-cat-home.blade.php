            ...
            <div class="row">
                ...
                <div class="col-sm-9 padding-right">
                    <div class="features_items">
                        ...
                        @foreach ($catproduct as $product_by_cat)

                        <div class="col-sm-4">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <img src="{{ asset('storage/product'.'/'.$product_by_cat->product_image) }}" alt="" />
                                        <h2>${{$product_by_cat->price}}</h2>
                                        <p>{{$product_by_cat->product_name}}</p>
